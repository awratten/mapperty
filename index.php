...
//});
            ...
            var m_cluster = L.markerClusterGroup({ chunkedLoading: true });
                ...
                m_cluster.addLayer(L.marker([-16.98925, 145.74459], {icon: SA_Logo}).addTo(map).bindPopup("<a href='http://sheldonavenue.com.au' target='_blank'><button class='btn'>Visit Website</button></a>")); //Sheldon Avenue
